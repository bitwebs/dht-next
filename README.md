...
```
npm install @web4/dht@next
```

Built on top of [dht-rpc](https://github.com/mafintosh/dht-rpc).

The BitWeb DHT uses a series of hole punching techniques to make sure connectivity works on most networks,
and is mainly used to facilitate finding and connecting to peers using end to end encrypted Noise streams.

## NOTE: v2

Note that this is the README for v2 which is tagged under next.
To see the v1 documentation/code go to https://github.com/bitwebs/dht/tree/v1
...
```js
{
  ...
  // Defaults to ['t1.bitdht.com:49736', 't2.bitdht.com:49736', 't3.bitdht.com:49736']
  bootstrap: ['host:port'],
  keyPair // set the default key pair to use for server.listen and connect
}
```

See [dht-rpc](https://github.com/mafintosh/dht-rpc) for more options as BitWebDHT inherits from that.
...
If you want to run your own BitWeb network use this method to easily create a bootstrap node.
